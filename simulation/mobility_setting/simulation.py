...
for algorithmIndex in algorithmIndexList:
    ...
    # process the results
    subprocess.check_output("nohup bash processResults.sh " + str(numUser) + " " + str(numNetwork) + " " + networkDataRate + " " + str(maxNumIteration) + " " + str(numRun) + " " + str(numParallelRun) + " " + str(convergedProb) + " " + str(saveMinimalDetail) + " " + str(epsilon) + " " + resultDir + " " + algorithmName + " > nohup_process.out", shell=True, universal_newlines=True)
